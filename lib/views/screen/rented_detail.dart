...
class RentedDetailScreen extends StatefulWidget {
  const RentedDetailScreen({super.key});

  @override
  State<RentedDetailScreen> createState() => _RentedDetailScreenState();
}

class _RentedDetailScreenState extends State<RentedDetailScreen> {
...
Page resource error:
  ...
  isForMainFrame: ${error.isForMainFrame}
      ...
      ..loadRequest(
          Uri.parse('${AppConfig.BASE_URL}e_dashboard/rented_details.php'));
